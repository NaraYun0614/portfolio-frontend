...
function About() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-200 to-white flex items-center justify-center px-6">
      <div className="max-w-5xl w-full grid grid-cols-1 md:grid-cols-5 items-center gap-8 animate-fade-in">
        ...
        <div className="text-center md:text-left space-y-6 md:col-span-3">
          <h1 className="text-center text-4xl font-bold text-blue-900">About Me</h1>
          <p className="text-gray-800 text-lg leading-relaxed">
            I'm a third-year <span className="font-semibold text-blue-700">Software Engineering student</span> at McGill University with a minor in Artificial Intelligence. I love turning complex ideas into real, usable applications.
          </p>
          <p className="text-gray-800 text-lg leading-relaxed">
