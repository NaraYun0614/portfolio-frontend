...
function Home() {
    return(
        <div className="min-h-screen  bg-gradient-to-br from-blue-100 to-indigo-500 flex items-center justify-center">
            <div className="flex flex-col md:flex-row items-center justify-center gap-14 w-full max-w-5xl px-6">
                ...
                <div className="text-white max-w-xl text-center">
                    <h1 className="text-center text-4xl font-bold mb-4 text-indigo-600">Hi, I'm Nara Yun!</h1>
